...
! function (t, e) {
    ...
    function convertToPath(t, e) {
        var n, r, o, i, a, h, s, l, g, c, p, f, u, d, _, m, w, v, P, y, x, T, O = t.tagName.toLowerCase(),
            M = .552284749831;
        return "path" !== O && t.getBBox ? (h = function _createPath(t, e) {
            ...
            return r
        }(t, A[O]), "rect" === O ? (i = T.rx, a = T.ry || i, r = T.x, o = T.y, c = T.width - 2 * i, p = T.height - 2 * a, n = i || a ? "M" + (m = (d = (u = r + i) + c) + i) + "," + (v = o + a) + " V" + (P = v + p) + " C" + [m, y = P + a * M, _ = d + i * M, x = P + a, d, x, d - (d - u) / 3, x, u + (d - u) / 3, x, u, x, f = r + i * (1 - M), x, r, y, r, P, r, P - (P - v) / 3, r, v + (P - v) / 3, r, v, r, w = o + a * (1 - M), f, o, u, o, u + (d - u) / 3, o, d - (d - u) / 3, o, d, o, _, o, m, w, m, v].join(",") + "z" : "M" + (r + c) + "," + o + " v" + p + " h" + -c + " v" + -p + " h" + c + "z") : "circle" === O || "ellipse" === O ? (l = "circle" === O ? (i = a = T.r) * M : (i = T.rx, (a = T.ry) * M), n = "M" + ((r = T.cx) + i) + "," + (o = T.cy) + " C" + [r + i, o + l, r + (s = i * M), o + a, r, o + a, r - s, o + a, r - i, o + l, r - i, o, r - i, o - l, r - s, o - a, r, o - a, r + s, o - a, r + i, o - l, r + i, o].join(",") + "z") : "line" === O ? n = "M" + T.x1 + "," + T.y1 + " L" + T.x2 + "," + T.y2 : "polyline" !== O && "polygon" !== O || (n = "M" + (r = (g = (t.getAttribute("points") + "").match(b) || []).shift()) + "," + (o = g.shift()) + " L" + g.join(","), "polygon" === O && (n += "," + r + "," + o + "z")), h.setAttribute("d", rawPathToString(h._gsRawPath = stringToRawPath(n))), e && t.parentNode && (t.parentNode.insertBefore(h, t), t.parentNode.removeChild(t)), h) : t
    }
    ...
    var n, C, F, I, o, P = Math.atan2,
        ...
        K = {
            ...
            init: function init(t, e, n, r, o) {
                if (I || ma(1), !e) return L("invalid shape"), !1;
                ("string" == typeof e || e.getBBox || e[0]) && (e = {
                    shape: e
                });
                var i, a, h, s, l, g, c, p, f, u, d, _, m, w, v, P, y, x, O, M, S, b, N = t.nodeType ? window.getComputedStyle(t) : {},
                    R = N.fill + "",
                ...
                if (g = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", c = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, s) {
                    if (this._target = t, y = "object" == typeof e.precompile, u = this._prop ? t[this._prop] : t.getAttribute(a), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" == a || this._prop) {
                        ...
                        for ("log" !== e.precompile && !0 !== e.precompile || L('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (u = ha(u, e.smoothTolerance), d = ha(d, e.smoothTolerance), u.size || T(u), d.size || T(d), M = ia(z[0]), this._origin = u.origin = {
                                x: u.left + M.x * u.width,
                                y: u.top + M.y * u.height
                            }, z[1] && (M = ia(z[1])), this._eOrigin = {
                                x: d.left + M.x * d.width,
                                y: d.top + M.y * d.height
                            }), this._rawPath = t._gsRawPath = u, m = u.length; - 1 < --m;)
                            for (v = u[m], P = d[m], p = v.isSmooth || [], f = P.isSmooth || [], w = v.length, _ = F = 0; _ < w; _ += 2) P[_] === v[_] && P[_ + 1] === v[_ + 1] || (S ? p[_] && f[_] ? (x = v.smoothData, O = P.smoothData, b = _ + (_ === w - 4 ? 7 - w : 5), this._controlPT = {
